...
repos_raw = os.getenv(
    "HF_MODEL_REPOS",
    "albaz2000/marbert-arabic-itsm-l3-categories,albaz2000/arabert-arabic-itsm-l3-categories,albaz2000/byt5-arabic-itsm-l3-categories,albaz2000/egybert-arabic-itsm-l3-categories",
)
